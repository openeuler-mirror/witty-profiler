...
class TestConsoleGraphSubscriber(unittest.TestCase):
    ...
    @patch("witty_profiler.subscriber.implementations.graph_subscribers.LOGGER")
...
class TestHttpPostGraphSubscriber(unittest.TestCase):
    ...
    @patch("witty_profiler.subscriber.implementations.graph_subscribers.requests.post")
...
class TestMongoDBGraphSubscriber(unittest.TestCase):
    ...
    @patch(
        "witty_profiler.subscriber.implementations.graph_subscribers.MongoClient", create=True
    )
