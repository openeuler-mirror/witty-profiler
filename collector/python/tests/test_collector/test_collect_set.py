...
from witty_profiler.collector.local_collector import LocalCollector
...
class TestCollectorSetGraphOperations(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._config_patcher = patch("witty_profiler.collector.collect_set.GlobalConfigManager")
...
class TestCollectorSetEdgeCases(unittest.TestCase):
    ...
    def test_subcollector_raises_exception_in_get_seed_graph(self):
        ...
        with patch("witty_profiler.collector.collect_set.GlobalConfigManager") as mock_mgr:
            mock_config = Mock()
