"""Unit tests for Witty Profiler backend base classes and registry.
...
class TestServer(unittest.TestCase):
    ...
    def setUp(self):
        """Create mock WittyProfilerCore for testing."""
...
class TestServerFactory(unittest.TestCase):
    ...
    def test_server_factory_uses_default_core_when_none_provided(self):
        """Test that factory uses WittyProfilerCore default when core is None."""
        ...
        with patch("witty_profiler.controller.witty_profiler_core.WittyProfilerCore") as mock_witty_profiler_core:
            mock_instance = MagicMock()
            mock_witty_profiler_core.get_instance.return_value = mock_instance

            server = factory.create_server(core=None)

            self.assertIsNotNone(server)
            self.assertIsInstance(server, DefaultCoreServer)
            mock_witty_profiler_core.get_instance.assert_called_once()
