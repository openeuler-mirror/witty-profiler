"""Remote Witty Profiler Server collector via REST API.

Collects topology graphs from remote Witty Profiler servers through HTTP requests,
...
Notes:
    - Requires remote Witty Profiler server running with FastAPI backend
...
from witty_profiler.backend.backend_client import (
    RemoteBackendClient,
...
from witty_profiler.config_manager.configs import RemoteSlaveConfig
from witty_profiler.edge.edge import Edge
from witty_profiler.entity.entity_base import Entity
from witty_profiler.entity.entity_namespace import EntityNameSpace
