...
Notes:
    NaiveMemoryStorageGraphSubscriber is used by WittyProfilerCore for get_last_graph().
...
from witty_profiler.subscriber.subscribers import Graph, GraphSubscriber
    ...
    class MongoDBGraphSubscriber(GraphSubscriber):
        ...
        Example:
            ...
            subscriber = MongoDBGraphSubscriber(
                ...
                post_attr={"source": "witty_profiler", "version": "1.0"}
            )
