...
from witty_profiler.common.constants import PKG_WITTY_PROFILER_PATH
...
class SocketSnifferConfig:
    ...
    data_file_path: str = field(default="witty_profiler.socket_sniffer.csv")
...
class CPUSnifferConfig:
    ...
    cache_data_file_path: str = field(default="witty_profiler.cache_miss.csv")
    sched_data_file_path: str = field(default="witty_profiler.sched_monitor.csv")
    maximum_log_file_size_in_mb: int = field(default=100)
    maximum_rotation_cnt: int = field(default=3)
