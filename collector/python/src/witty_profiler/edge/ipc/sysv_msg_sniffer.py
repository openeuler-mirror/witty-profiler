"""System V Message Queue sniffer interface for IPC communication monitoring."""
...
class SysVMsgSniffer:
    """System V Message Queue sniffer that monitors msgsnd/msgrcv operations."""
    ...
    def _find_binary(self) -> str:
        ...
        candidates = [
            os.path.join(ebpftools_dir, "sysv_msg_sniffer", "sysv_msg_sniffer"),
            "sysv_msg_sniffer",
        ]
    ...
    def start(self, pid_filter: Optional[int] = None, interval: int = 1,
        ...
        """Start the System V message queue sniffer.
    ...
    def get_events(self) -> List[SysVMsgEvent]:
        """Get events from the sniffer.
        
        Returns:
            List of SysVMsgEvent objects
        """
    ...
    def _parse_line(self, line: str) -> Optional[SysVMsgEvent]:
        """Parse a CSV output line into a SysVMsgEvent."""
        line = line.strip()
