"""Pipe/FIFO sniffer interface for IPC communication monitoring."""
...
class PipeSniffer:
    """Pipe/FIFO sniffer that monitors anonymous pipes and named pipes (FIFOs)."""
    ...
    def _find_binary(self) -> str:
        ...
        candidates = [
            os.path.join(ebpftools_dir, "pipe_sniffer", "pipe_sniffer"),
            "pipe_sniffer",
        ]
    ...
    def get_events(self) -> List[PipeEvent]:
        """Get events from the sniffer.
        
        Returns:
            List of PipeEvent objects
        """
    ...
    def _parse_line(self, line: str) -> Optional[PipeEvent]:
        """Parse a CSV output line into a PipeEvent."""
        line = line.strip()
