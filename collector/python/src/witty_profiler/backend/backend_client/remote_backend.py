"""Abstract client interface for remote Witty Profiler backend access.

Defines RemoteBackendClient ABC and related error types for communicating
with remote Witty Profiler servers. Concrete implementations (e.g., RestfulRemoteBackendClient)
...
class RemoteBackendClient(ABC):
    """Abstract client for accessing remote Witty Profiler backend."""
