...
This guide walks you through installing Witty Profiler and its dependencies.
...
git clone https://github.com/yourusername/witty-profiler.git
cd witty-profiler
...
# With HTTP server
pip install witty-profiler[server]
```
...
Without these dependencies, Witty Profiler runs in offline mode only.
...
# Stop server
pkill -f "python -m witty_profiler"
```
...
- **[Architecture Overview](../architecture/overview.md)**: Understand Witty Profiler's design
...
Witty Profiler requires WSL2 on Windows:
