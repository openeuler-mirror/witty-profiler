...
### Binary
```bash
./src/witty_profiler/binary/posix_mq/posix_mq_sniffer [options]
```
...
sudo ./src/witty_profiler/binary/posix_mq/posix_mq_sniffer -d recv -i 2
```
...
```python
from witty_profiler.tools.ebpftools.posix_mq_sniffer import PosixMqSniffer
