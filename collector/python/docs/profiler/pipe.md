...
### Binary
```bash
./src/witty_profiler/binary/pipe/pipe_sniffer [options]
```
...
sudo ./src/witty_profiler/binary/pipe/pipe_sniffer -d write -p 1234
```
...
```python
from witty_profiler.tools.ebpftools.pipe_sniffer import PipeSniffer
