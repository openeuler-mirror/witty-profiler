...
- 用户态加载器：`src/witty_profiler/tools/ebpftools/cache_monitor_c/main.cpp`
- eBPF 源：`src/witty_profiler/tools/ebpftools/cache_monitor_c/ebpf/cache_miss_monitor.bpf.c`
- 构建脚本：`src/witty_profiler/tools/ebpftools/cache_monitor_c/CMakeLists.txt`
...
cmake -B src/witty_profiler/binary/cache_miss -S src/witty_profiler/tools/ebpftools/cache_monitor_c -DCACHE_OUTPUT_MSGSPEC=OFF
cmake --build src/witty_profiler/binary/cache_miss
```
...
- `src/witty_profiler/binary/cache_miss/cache_miss_monitor_bpf.o`（eBPF 对象）
- `src/witty_profiler/binary/cache_miss/cache_miss_monitor`（用户态加载器）

## 运行

```bash
sudo src/witty_profiler/binary/cache_miss/cache_miss_monitor [-v] [-p <PID>] [-t <TID>] [-c <CPU_ID>] [-i <SECONDS>] [-d <SECONDS>] [-s <PERIOD>] [-o src/witty_profiler/binary/cache_miss/cache_miss_monitor_bpf.o]
```
