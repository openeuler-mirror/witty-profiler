...
### Binary
```bash
./src/anansi/binary/sysv_sem/sysv_sem_sniffer [options]
```
...
sudo ./src/anansi/binary/sysv_sem/sysv_sem_sniffer -p 1234
```
...
```python
from anansi.tools.ebpftools.sysv_sem_sniffer import SysvSemSniffer
