...
本文档描述 Anansi 的图模型，包括实体（Entity）、边（Edge）和 ID 语义。
...
实体定义在 [src/anansi/entity/node_entity](../../src/anansi/entity/node_entity) 目录下。
...
定义在 [src/anansi/entity/node_entity/rdma.py](../../src/anansi/entity/node_entity/rdma.py)：
...
边定义在 [src/anansi/edge](../../src/anansi/edge) 目录下。
