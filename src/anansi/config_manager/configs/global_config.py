...
from anansi.common.constants import SocketSnifferConstants
from anansi.config_manager.configs.server_config import ServerConfig
...
@dataclass
class GlobalConfig:
    tmp_dir: str = field(default_factory=lambda: "local/anansi/run/")
