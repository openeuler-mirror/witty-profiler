"""Base server interface and registry for Anansi HTTP backends.
...
class Server(metaclass=ServerMeta):
    ...
    def __init__(self, core):
        """Initialize server with AnansiCore instance.

        Args:
            core: AnansiCore singleton for topology collection
        """
        self._core = core
...
class ServerFactory(ThreadSafeSingleton):
    ...
    def _ensure_servers_imported(self):
        ...
        try:
            ...
            import anansi.backend.default_server  # noqa: F401
        except ImportError:
            LOGGER.debug("Failed to import default_server")

        try:
            # pylint: disable=import-outside-toplevel,unused-import
            import anansi.backend.fastapi_server  # noqa: F401
        except ImportError:
    ...
    def create_server(
        ...
        Args:
            ...
            core: AnansiCore instance (creates new if None)
