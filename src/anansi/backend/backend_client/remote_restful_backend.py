"""RESTful backend client for Anansi remote server communication.

Provides RestfulRemoteBackendClient, an HTTP client implementation that
communicates with Anansi FastAPI servers using REST endpoints. Exposes
...
Key Components:
    ...
    - Routes sourced from AnansiServerConstants for consistency
...
Notes:
    - Routes from AnansiServerConstants avoid path drift with server
...
from anansi.backend.backend_client.remote_backend import (
    RemoteBackendClient,
