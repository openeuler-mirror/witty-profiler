...
from anansi.common.constants import CONNECTION_TYPE_TCP, TimeConstants
from anansi.edge.edge_category import DataStreamEdge
from anansi.entity.node_entity import ProcessEntity, SocketEntity, ThreadEntity
