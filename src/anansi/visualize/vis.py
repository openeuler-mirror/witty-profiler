...
from anansi.visualize.renderer.renderer_base import LayoutRenderer
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        prog="anansi-visualize",
        description="Anansi - Visualize AI system topology",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # Visualize AI system topology
  python -m anansi-vis <input-json-file-path> -of <output-format> -o <output-path>
""",
    )
    parser.add_argument(
